...
// TODO )
// TODO
// TODO // App is the main/root application window.
// TODO var App *Window
// TODO
...
//TODO 	}
//TODO
//TODO 	initOnce.Do(func() {
//TODO 		runtime.LockOSThread()
//TODO 		if tclDir, Error = tcl.Stdlib(); Error != nil {
//TODO 			return
//TODO 		}
//TODO
//TODO 		if tkDir, Error = stdlib(); Error != nil {
//TODO 			return
//TODO 		}
//TODO
//TODO 		if interp, Error = tcl.NewInterp(map[string]string{
//TODO 			"tcl_library": tclDir,
//TODO 			"tk_library":  tkDir,
//TODO 		}); Error != nil {
//TODO 			return
//TODO 		}
//TODO
//TODO 		if rc := libtk.XTk_Init(interp.TLS(), interp.Handle()); rc != libtk.TCL_OK {
//TODO 			interp.Close()
//TODO 			Error = fmt.Errorf("failed to initialize the Tk subsystem")
//TODO 			return
//TODO 		}
//TODO
//TODO 		Error = interp.RegisterCommand("eventDispatcher", eventDispatcher, nil, nil)
//TODO 	})
//TODO 	if Error == nil {
...
//TODO }
//TODO
//TODO // Graph — use gnuplot to draw on a canvas. Graph returns 'w'.
//TODO //
//TODO // The 'script' argument is passed to a gnuplot executable, which must be
//TODO // installed on the machine.  See the [gnuplot site] for documentation about
//TODO // producing graphs. The script must not use the 'set term <device>' command.
//TODO //
//TODO // [gnuplot site]: http://www.gnuplot.info/
//TODO func (w *CanvasWidget) Graph(script string) *CanvasWidget {
//TODO 	script = fmt.Sprintf("set terminal tkcanvas size %s, %s\n%s", w.Width(), w.Height(), script)
//TODO 	out, err := gnuplot(script)
//TODO 	if err != nil {
//TODO 		fail(fmt.Errorf("plot: executing script: %s", err))
//TODO 		return w
//TODO 	}
//TODO
//TODO 	evalErr(fmt.Sprintf("%s\ngnuplot %s", out, w))
//TODO 	return w
//TODO }
//TODO
//TODO func gnuplot(script string) (out []byte, err error) {
//TODO 	f, err := os.CreateTemp("", "tk8.6-")
//TODO 	if err != nil {
//TODO 		return nil, err
//TODO 	}
//TODO
...
//TODO
//TODO 	if err := os.WriteFile(f.Name(), []byte(script), 0660); err != nil {
//TODO 		return nil, err
//TODO 	}
//TODO
//TODO 	ctx, cancel := context.WithTimeout(context.Background(), gnuplotTimeout)
//TODO
//TODO 	defer cancel()
//TODO
//TODO 	return exec.CommandContext(ctx, "gnuplot", f.Name()).Output()
//TODO }
//TODO
//TODO // Menu — Create and manipulate 'menu' widgets and menubars
//TODO //
//TODO // # Description
//TODO //
//TODO // Add a new command entry to the bottom of the menu.
//TODO //
//TODO // Additional information might be available at the [Tcl/Tk menu] page.
//TODO //
//TODO // [Tcl/Tk menu]: https://www.tcl.tk/man/tcl8.6/TkCmd/menu.htm
//TODO func (w *MenuWidget) AddCommand(options ...Opt) {
//TODO 	evalErr(fmt.Sprintf("%s add command %s", w, winCollect(w.Window, options...)))
//TODO }
//TODO
//TODO // Menu — Create and manipulate 'menu' widgets and menubars
//TODO //
//TODO // # Description
//TODO //
//TODO // Add a new cascade entry to the end of the menu.
//TODO //
//TODO // Additional information might be available at the [Tcl/Tk menu] page.
//TODO //
//TODO // [Tcl/Tk menu]: https://www.tcl.tk/man/tcl8.6/TkCmd/menu.htm
//TODO func (w *MenuWidget) AddCascade(options ...Opt) {
//TODO 	evalErr(fmt.Sprintf("%s add cascade %s", w, winCollect(w.Window, options...)))
//TODO }
//TODO
//TODO // Menu — Create and manipulate 'menu' widgets and menubars
//TODO //
//TODO // # Description
//TODO //
//TODO // Add a new separator entry to the bottom of the menu.
//TODO //
//TODO // Additional information might be available at the [Tcl/Tk menu] page.
//TODO //
//TODO // [Tcl/Tk menu]: https://www.tcl.tk/man/tcl8.6/TkCmd/menu.htm
//TODO func (w *MenuWidget) AddSeparator(options ...Opt) {
//TODO 	evalErr(fmt.Sprintf("%s add separator %s", w, winCollect(w.Window, options...)))
//TODO }
//TODO
//TODO // Menu — Create and manipulate 'menu' widgets and menubars
//TODO //
//TODO // # Description
//TODO //
//TODO // Invoke the action of the menu entry. See the sections on the individual
//TODO // entries above for details on what happens. If the menu entry is disabled
//TODO // then nothing happens. If the entry has a command associated with it then the
//TODO // result of that command is returned as the result of the invoke widget
//TODO // command. Otherwise the result is an empty string. Note: invoking a menu
//TODO // entry does not automatically unpost the menu; the default bindings normally
//TODO // take care of this before invoking the invoke widget command.
//TODO //
//TODO // Additional information might be available at the [Tcl/Tk menu] page.
//TODO //
//TODO // [Tcl/Tk menu]: https://www.tcl.tk/man/tcl8.6/TkCmd/menu.htm
//TODO func (w *MenuWidget) Invoke(index uint) {
//TODO 	evalErr(fmt.Sprintf("%s invoke %d", w, index))
//TODO }
