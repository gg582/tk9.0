...
import (
	...
	util "github.com/yoonjin67/fileutil/ccgo"
	...
	ngrab "github.com/yoonjin67/ngrab/lib"
	"github.com/yoonjin67/rec/lib"
)
...
func (j *job) main() {
	...
	for _, k := range a {
		...
		case ok:
			j.w("\n//\n// [Event handlers]: https://pkg.go.dev/github.com/yoonjin67/tk9.0#hdr-Event_handlers")
